<div class="row m-1 dark-bg rounded">
    <div class="p-2">
        <h3 class="text-light">categories
        </h3>
...
<div class="row m-4">
    <div class="col-sm-2 mt-1">
        <a style="text-align: center;" class="btn btn-lg btn-danger btn-block" href="/templates/torrents/games_torrents.php?type=torrents?category=games">
            <b> <i class="fas fa-gamepad"></i> Games</b></a>
    </div>
    <div class="col-sm-2 mt-1">
        <a style="text-align: center;" class="btn btn-lg btn-success btn-block" href="/templates/torrents/movies_torrents.php?type=torrents?category=movies">
